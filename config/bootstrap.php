...
try {
    ...
    Configure::load("constMail");
    Configure::load("constPrice");
    Configure::load("examResult/ba1");
 ...
 */
ini_set('intl.default_locale', Configure::read('App.defaultLocaleJP'));
...
$this->addPlugin('TestManager');
$this->addPlugin('Managers');
