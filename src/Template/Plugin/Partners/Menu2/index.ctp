    ...
    <div class="row ">
        ...
        <div class="col-md-12">
            ...
            <div class="box" id="lists">
                ...
                <div class="box-body">
                    <form action="/partners/menu2/<?=$param?>" method="POST" enctype="multipart/form-data" >
                    <table class="table table-bordered " >
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($param == "add"):?>
                                        <input type="text" class="form-control" value="<?=$login_id?>" name="login_id" />
                                        <small><?=__("hankakueisu4")?></small>
                                    <?php else: ?>
                                        <small><?=$login_id?></small>
                                    <?php endif;?>
                        ...
                        <div class="mt20" >
                            ...
                            //新規登録の時
                            if($param == "add"):?>
                                <input type="submit" name="customer_regist" value="<?=__("regist")?>" class="btn btn-primary" />
                            <?php else: ?>
                                <input type="hidden" name="editid" value="<?=h($editid)?>" />
                                <input type="submit" name="customer_edit" value="<?=__("regist")?>" class="btn btn-primary" />
                            <?php endif;?>
                        </div>
                    </form>
                    <input type="hidden" id="customerRegistConfirm" value="<?=__("customerRegistConfirm")?>" />
...
$(function(){
    //パートナー画面データ登録
    $("input[name='customer_regist']").click(function(){
        var _txt1 = $("#customerRegistConfirm").val();
        if(confirm(_txt1)){
            return true;
        }
        return false;
